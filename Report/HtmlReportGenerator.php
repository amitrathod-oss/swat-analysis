...
class HtmlReportGenerator
{
    ...
    private function render(array $report): string
    {
        ...
        return '<!doctype html><html lang="en"><head><meta charset="utf-8">'
            ...
            . $this->styles() . '</style></head><body><footer>Asiamarket HealthCheck <span>Internal health assessment</span></footer><main>'
    ...
    {
        return '<section class="cover page-break"><div class="brand">ASIAMARKET<span>HEALTHCHECK</span></div><div class="cover-copy">'
